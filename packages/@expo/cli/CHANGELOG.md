...
- The dev server serves the current project fingerprint at `GET /_expo/fingerprint`, records what a connected app reports, and warns in the terminal when the installed app is stale. ([#48923](https://github.com/expo/expo/pull/48923) by [@vonovak](https://github.com/vonovak))
